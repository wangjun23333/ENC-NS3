...
void EnquserverNode::SendToDev(Ptr<Packet>p, MyCustomHeader &ch){
...
//bool EnquserverNode::SwitchReceiveFromDevice(Ptr<NetDevice> device, Ptr<Packet> packet, MyCustomHeader &ch){
